...
Chen, B., Guo, F., Liu, Y., Zhong, H., Deng, C., Chen, B., and Chen, Z. Difficulty-Controllable Traffic Scenario Generation for Automated-Driving Evaluation via Context-Matched Residual Diffusion. Transportation Research Part C: Emerging Technologies, under review.
